  ...
  if (objects.length > 0) {
    for (let i = 0; i < objects.length; i++) {
      ...
      if (adresa.match(/pilulka/gi)) {
        //Pilulka
        objednat =
          '<a class="objednat" target="blank" href="https://www.pilulka.cz/escapelle-por-tbl-nob-1x1-5mg">Přejít na E-shop!</a>';
      } else if (adresa.match(/benu/gi)) {
        objednat =
          '<a class="objednat" target="blank" href="https://www.benu.cz/escapelle-peroralni-neobalene-tablety-1x1-5mg">Přejít na E-shop!</a>';
      } else {
        objednat = "";
      }
      finalString += `
